...
function Footer() {
    return(
        <footer>
            ...
            <div className="footer--icon">
                <a href="https://www.facebook.com/kwachoo">
            ...
            <div className="footer--icon">
                <a href="https://www.instagram.com/lk_design_pl/">
            ...
            <div className="footer--icon">
                <a href="https://www.linkedin.com/in/lukaszkwasinski/">
